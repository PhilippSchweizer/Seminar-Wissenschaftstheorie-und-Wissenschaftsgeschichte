...
Im fünften Teil seines Aufsatzes geht Burian direkt auf die Herausforderung Gieres ein, dass historische Forschung nicht notwendig für die WPh ist, sondern nur *ein* Mittel, sie in verbesserten Kontakt mit wirklicher Wissenschaft zu bringen, ersetzbar die Erforschung zeitgenössischer Wissenschaft.
...
> "... the overall picture of recent philosophy of science [...] is one of a discipline dominated by a concern with formal systems having little relevance to actual scientific theories or practices. History of science is seen as the means, or at least *a* means, of remedying the situation." [@giere1973, S. 290]

> "Contrary to the spirit of some remarks [...], no logical empiricist ever thought that the form, content, or methods of science may be derived from formal logic alone. For traditional logical empiricists, the task of the philosopher was always the rational reconstruction and explication of theories, methods and meta-concepts found in actual scientific practice. Where logical empiricism failed was in the application and justification of this approach." [@giere1973, S. 290]

> "On the above account of the failing of logical empiricism, it does not follow that history of science, as such, promises any remedies. The most direct response would be to develop more flexible logical and mathematical tools, to pay closer attention to actual scientific theories, and to worry more about the nature of philosophical conclusions about science." [@giere1973, S. 291]


> "However, the debate cannot be settled on these grounds alone. For when Giere claimed that the history of science has no significant bearing on the philosophy of science, he was not claiming that philosophers should ignore the science and scientific practices of the past. The argument was hardly this simple-minded. Giere was instead, and more pointedly, arguing that the sort of history that historians of science take as paradigmatic to their discipline -- a fine-grained and often complex history, focused, more or less, on the specific events, context, and influences surrounding the development and acceptance or rejection of a concept or theory -- is not the sort of history from which philosophers can *prima facie* draw useful lessons. Much philosophical use of history (e.g., as exercised by Laudan) does not involve history of that sort." [@domski2010, S. 2f.]

> "For Giere, then, the fact that our contemporary philosophical discourse is peppered with appeals to and examples from the past hardly counts as genuine evidence that the history of science and the philosophy of science are involved in an intimate relationship. Any such evidence for this relationship will come from a more reflective consideration of the conceptual ties between these disciplines. In particular, Giere urges that historically-minded philosophers 'not be content merely to practice their art but [...] make repeated efforts to explain and argue the rationale for their approach' (Giere 1973, 291), and he solicits from historian-philosophers an account of how 'philosophical conclusions may be supported by historical facts.' 'Until this is done,' he writes, 'the historical approach to philosophy of science is without a conceptually coherent program' (1973, 292)." [@domski2010, S. 3]


> "In den Diskussionen um die Theorien von Popper und Kuhn offenbart sich die weltanschauliche Krise, in die solche Methodologien geraten sind, die sich gegen die marxistisch-leninistische Philosophie richten und eine Erkenntnistheorie aufbauen wollen, die die gesellschaftlichen Determinanten der wissenschaftlichen Arbeit nicht berücksichtigt." [@horz1976, S. 751]
...
rational reconstruction
  ...
  :   "an application of verificationism that results in the elimination of the metaphysical features of a concept or theory while preserving its empirically testable content." (Boyd 1991, S. 6)
  :   Geht das überhaupt, jeden "metaphysischen" Gehalt eines Begriffs oder einer Theorie zu eliminieren? Haben empirisch überprüfbare Aussagen überhaupt keinen "metaphysischen" Gehalt?
...
- Will er den logischen Empirismus retten? Nein, er will in angemessen abschwächen.
- Will er eine bestimmte Form des Historismus in der WTh durchsetzen? Ja, dass schon eher. ... Schauen wir in seine Konklusion

- Unterschied zwischen Wissenschaftsgeschichte und historischer (?) Philosophie: nur ein terminologisches Problem? Mir scheint, dass die Autoren hier sehr ungenau arbeiten, und dass, wenn von Wissenschaftsgeschichte die Rede ist, eigentlich eine historisch informierte oder nicht ahistorische philosophische Methode gemeint ist.


- Hat Wissenschaftsgeschichte einen Nutzen für Wissenschaftsphilosophie? (Hanson, Giere, McMullin, Burian, Kuhn)
- Hat Wissenschaftsphilosophie einen Nutzen für Wissenschaftsgeschichte? (Hanson, Giere, McMullin, Burian, Kuhn)
- Welche Beziehungen bestehen zwischen WG und WPh? (Kuhn)
- Braucht eine Wissenschaft Wissen über ihre Geschichte? (Krüger)
- In welchem Zusammenhang stehen WG und Geschichte der Philosophie (Friedman)
- Braucht Erkenntnistheorie Geschichte? (Kitcher)
...
Das Beispiel: eine vergleichende Darstellung der Artikel von @bunge1956 und @glymour1971. 

Abgesehen von dem Problem, wohin mit dem Beispiel, bleibt ja noch das Problem, dass ich noch gar keines habe. Aber es wäre schon sehr gut eines zu haben. Denn am Ende will ich doch zeigen, dass sowohl Giere als auch Burian am Kern des Problems vorbei gehen. Für beide sind ja die Unzulänglichkeiten des logischen Empirismus in der WPh ein Problem, wenn ich es richtig erfasst habe. Im Fazit dann die Frage: woraus resultieren diese? Gibt es vielleicht noch andere Probleme als fehlender historischer Zugang? Kurz: Kritik des Positivismus bzw. eines "strukturellen Theorieverständnisses" [@roseberg1984, S. 888]
...
# Die Diskussion der 1970er Jahre um das Verhältnis zwischen Wissenschaftsgeschichte und Wissenschaftsphilosophie (Hanson -- Lakatos -- Giere -- McMullin)
\vspace{-1.25em}



Kant schreibt in der *Kritik der reinen Vernunft*, dass Gedanken ohne Inhalt leer und Anschauungen ohne Begriffe blind sind. "Ohne Sinnlichkeit würde uns kein Gegenstand gegeben und ohne Verstand keiner gedacht werden." Es ist notwendig, dass Begriffe vergegenständlicht und Anschauungen begrifflich (d.i. begreiflich) werden müssen [vgl. @kant1998, A51/B75].

An diese Stelle dachte @hanson1962, als er über das Verhältnis zwischen WPh und WG reflektierte. Die WG mit der Sinnlichkeit und die WPh mit dem begrifflichen Denken identifizierend, kam er zu dem Schluss, dass Wissenschaftsgeschichte ohne Wissenschaftsphilosophie blind ist und Wissenschaftsphilosophie ohne Wissenschaftsgeschichte leer [vgl. @hanson1962, S. 575 u. 580]. Berühmt geworden für diesen Satz ist aber @lakatos1971, der, ohne jeglichen Bezug auf Hanson schreibt: "'Philosophy of science without history of science is empty; history of science without philosophy of science is blind.'" (S. 91)
...
- Worüber reden wir, wenn wir von Wissenschaftsgeschichte reden?
    ...
    + siehe dazu auch Laudan 1977 (Progress and its problems: Towards a theory of scientific growth), der laut @schindler2013 auf diese Ambiguität hinweist.
