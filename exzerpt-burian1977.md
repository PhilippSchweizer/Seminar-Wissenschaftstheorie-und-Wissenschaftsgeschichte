...
## (ii) Three Difficulties for Logicism (6--8)
1. Die Technik mit harten Fällen umzugehen, ist zu einfach: es macht wirkliche Wissenschaft vollkommen irrelevant für die Bewertung egal welcher kognitiven Standards die ein Philosoph möglicherweise vorschlägt.
2. Man müsste zeigen, dass Theorien, Erklärungen und Bestätigungen alle die selbe logische Form in allen Wissenschaften und zu jedem Zeitpunkt der Entwicklung von Wissenschaft. (Dass das gezeigt werden kann, hält Burian für sehr unwahrscheinlich)
...
degree of support (dos)
  ...
  :   "notion of probability that represents the degree to
 which evidence supports hypotheses." [@hawthorne2005, 277]
